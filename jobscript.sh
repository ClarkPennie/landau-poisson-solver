...
#SBATCH -N 12     # The number of nodes. n/N tasks are launched on each node. used in conjunction with the -n option (above). Use this option to specify launching less than 16 tasks per node. 
#SBATCH -p skx-normal     # Queue (partition) name  -- normal, largemem, development, gpu, etc.
