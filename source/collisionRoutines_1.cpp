...
#else
void ComputeQ(double *f, fftw_complex *qHat, double **conv_weights)				// function to calculate the discrete Fourier transform of the collision operator Q at a given f(Hat)
{
