...
double f_DH(double x)																				// function to calculate the value of f_DH(x) = sin^2((x-Lx/2)^2/Lx)*exp(-((x-Lx/2)^2)/2T)/(c*sqrt(2*pi*T)) (to create a double hump function, where c = 0.0145254 normalises mass to 1)
{
...
void SetInit(double *U)																				// function to calculate the DG coefficients for the initial condition for Landau Damping
{
